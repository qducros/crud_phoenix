defmodule CrudPhoenixWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CrudPhoenixWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CrudPhoenixWeb.Gettext, "errors", msg, opts)
    end
  end
